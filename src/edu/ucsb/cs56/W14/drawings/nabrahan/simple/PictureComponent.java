package edu.ucsb.cs56.w14.drawings.nabrahan.simple;
...
/**
   ...
   @author Nicholas Abrahan (fixed the snowmans's head)
...
{  
   ...
   {  
      ...
      Circle snowManMiddleCircle = 
       ...
       g2.drawString("Top of snowman added by Nicholas \"Circlemaster\" Abrahan", 20,40);
    }
